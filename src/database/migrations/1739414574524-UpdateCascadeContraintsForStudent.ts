...
export class UpdateCascadeContraintsForStudent1739414574524 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE student_teacher_relation ADD CONSTRAINT FK_f66fb757c787b22fdec93af0e0f FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE;`);
    }
