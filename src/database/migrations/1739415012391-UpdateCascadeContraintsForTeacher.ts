...
export class UpdateCascadeContraintsForTeacher1739415012391 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE student_teacher_relation ADD CONSTRAINT FK_f21780c847754f2bb2ca2b9fb82 FOREIGN KEY (teacher_id) REFERENCES teachers(id) ON UPDATE CASCADE ON DELETE CASCADE;`);
    }
